...
<footer className="footer bg-[#000000] text-base-content border-base-100 border-t px-10 py-4">
...
<div className="grid grid-flow-col gap-4">
  ...
  <svg
    ...
    <g fill="none">
      ...
      <g fill="#FFF">
        <rect width="24" height="2" y="2" />
        <rect width="24" height="2" y="6" />
        <rect width="24" height="2" y="10" />
...
<footer>
<div  className="footer bg-[#000000]  justify-center items-center text-center border-base-100  px-10 py-4">
    <p className='text-[#e7e8ef]'>EEVE © 2024. All rights reserved.</p>
  </div>
</footer>
